...
<head>
    ...
    <title>Nueva Cotización - Admin Wilberth</title>
...
<body class="bg-slate-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <nav class="hidden md:flex items-center gap-1 ml-4">
                    ...
                    <a href="/admin/quotes/create" class="px-4 py-2 text-sm font-medium bg-indigo-50 text-indigo-700 rounded-lg">Nueva Cotización</a>
                    ...
                    <a href="/admin/marketing-brief-links" class="px-4 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all">Marketing Briefs</a>
                </nav>
            </div>
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form method="POST" action="/admin/quotes" id="quote-form" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 space-y-4">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-bold text-slate-900">Servicios / Items</h3>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                <label for="notes" class="block text-sm font-medium text-slate-700 mb-1">Notas adicionales</label>
                <textarea id="notes" name="notes" rows="3"
                    class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"></textarea>
            </div>

            <div class="flex gap-3">
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-8 py-3 rounded-xl transition-colors">Crear Cotización</button>
                <a href="/admin/dashboard" class="bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium px-8 py-3 rounded-xl transition-colors">Cancelar</a>
            </div>
        </form>
    </main>
