    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="flex flex-wrap gap-3 mb-6 pb-6 border-b border-slate-200">
                <a href="/admin/invoices/create-from-quote/{{ $quote->id }}"
                    class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold px-5 py-2.5 rounded-lg transition-colors flex items-center gap-2">
