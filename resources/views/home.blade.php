...
<section class="bg-gradient-to-r from-indigo-600 to-indigo-800 text-white py-16 mb-12">
    <div class="max-w-4xl mx-auto text-center px-4">
        ...
        <p class="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">Creación de sitios web, aplicaciones web y tiendas en línea para emprendedores en Costa Rica. Llevá tu negocio al mundo digital.</p>
