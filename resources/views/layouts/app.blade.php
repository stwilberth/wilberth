        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden md:flex items-center gap-1">
                    ...
                    <a href="/demo" class="px-5 py-3 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl transition-all">Demos</a>
            ...
            <div id="mobile-menu" class="md:hidden hidden pb-4 border-t border-slate-100 pt-4">
                <nav class="flex flex-col gap-2">
                    ...
                    <a href="/demo" class="px-4 py-3.5 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl transition-all">Demos</a>
