...
<section class="bg-gradient-to-r from-indigo-600 to-indigo-800 text-white py-16 mb-12">
    <div class="max-w-4xl mx-auto text-center px-4">
        ...
        <p class="text-xl text-indigo-100 max-w-2xl mx-auto">Para poder crear una página que realmente ayude a tu negocio, quiero conocer un poco mejor lo que haces. Respondeme estas preguntas y te ayudo a diseñar la estrategia perfecta.</p>
    </div>
</section>
                    ...
                    <div class="space-y-3 mt-3">
                        ...
                        <div class="grid sm:grid-cols-2 gap-2">
                            @foreach ($goals as $goal)
                                <label class="flex items-center gap-2 p-3 border-2 border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50/50 cursor-pointer transition-all has-[:checked]:border-indigo-500 has-[:checked]:bg-indigo-50">
                        ...
                        <input type="text" name="main_goal_other" placeholder="Otro objetivo..."
                            class="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:border-indigo-500 focus:ring-0 transition-colors text-gray-900 mt-2"
