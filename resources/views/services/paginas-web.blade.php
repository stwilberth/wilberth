...
<section class="bg-gradient-to-r from-orange-600 to-orange-800 text-white py-16 mb-12">
    <div class="max-w-4xl mx-auto text-center px-4">
        ...
        <p class="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Creación de sitios web, aplicaciones web y tiendas en línea modernas para emprendedores. Todo lo que necesitas para llevar tu negocio al mundo digital.
        </p>
...
<section class="mb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <p class="text-gray-600 text-lg leading-relaxed mb-4">
            Ayudo a emprendedores como tú a tener presencia digital profesional sin complicaciones. Creo desde cero tu página web, aplicación web o tienda en línea usando tecnologías modernas que garantizan rapidez, seguridad y un diseño atractivo.
        </p>
...
<section class="mb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all hover:shadow-2xl hover:-translate-y-2 duration-300">
            <div class="bg-gradient-to-br from-blue-100 to-blue-200 p-6">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Landing Pages</h3>
                <p class="text-gray-600 text-sm">Páginas de aterrizaje optimizadas para conversiones, ideales para promociones y campañas específicas.</p>
            </div>
        </div>
        <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all hover:shadow-2xl hover:-translate-y-2 duration-300">
            <div class="bg-gradient-to-br from-green-100 to-green-200 p-6">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Apps Web</h3>
                <p class="text-gray-600 text-sm">Aplicaciones web interactivas: portales para clientes, sistemas de reservas, paneles de control, catálogos digitales y herramientas administrativas.</p>
            </div>
        </div>
        <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all hover:shadow-2xl hover:-translate-y-2 duration-300">
            <div class="bg-gradient-to-br from-purple-100 to-purple-200 p-6">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Tiendas en Línea</h3>
                <p class="text-gray-600 text-sm">Tu tienda en línea lista para vender: catálogo de productos, carrito de compras, pasarela de pago y gestión de pedidos. Todo listo para empezar a vender.</p>
            </div>
        </div>
    </div>
</section>
