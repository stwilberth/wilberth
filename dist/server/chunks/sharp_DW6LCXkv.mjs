...
import { M as MissingSharp, P as NoImageMetadata, Q as UnsupportedImageFormat, t as AstroError } from "./errors_BJlaZ6cI.mjs";
import { c as resolveDefaultOutputFormat, o as detector, r as parseQuality, t as baseService } from "./service_DnRpEKIi.mjs";
//#region node_modules/.pnpm/astro@7.0.3_@emnapi+core@1._d96595ed78f349b005da83d0213ae539/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./lib_C7bWOzeT.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default;
	} catch {
